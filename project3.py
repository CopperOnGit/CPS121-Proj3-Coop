# CPS121 Project 3
# Written: <November 21st> <Cooper Papp> <cooper.papp@gordon.edu>
# 
# <This program takes the image of my dad's 2001 Dodge Dakota and changes it. It goes through 
# multiple altercations to make it look different from the original, through the mirroring of it and 
# the altercations to the colors of the image. >
##
...
def createWebPage(imageFile, webPageFile):
    ...
    <img src="swag.png" alt= "Cooper's Collage should go here">
    </body>
    </html>
    """
